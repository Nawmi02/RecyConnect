...
load_dotenv(BASE_DIR / ".env")  #env load
...
SECRET_KEY = 'django-insecure-o6c2yk7jz3(eezi*#2o8x0)531d6i4h6b!jm*05e8-zhxbt++j'
...
EMAIL_HOST_PASSWORD = os.getenv('GMAIL_APP_PWD')    
